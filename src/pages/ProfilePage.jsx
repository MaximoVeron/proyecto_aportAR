...
const ProfilePage = () => {
  ...
  const handleCancel = () => {
    setEditing(false);
    setFormData({ name: currentUser?.name, bio: currentUser?.bio, avatarFile: null });
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-bold gradient-text mb-8">Mi Perfil</h1>
          ...
          <div className="flex-1 w-full">
            {editing ? (
              ...
              <div>
                ...
                <p className="text-green-600 dark:text-green-400 font-semibold mb-1">{currentUser?.role}</p>
                {currentUser?.career && (
                  <p className="text-gray-600 dark:text-gray-400 mb-4">{currentUser.career}</p>
                )}
                <p className="text-gray-700 dark:text-gray-300 mb-4">{currentUser?.bio || 'Sin biografía'}</p>
